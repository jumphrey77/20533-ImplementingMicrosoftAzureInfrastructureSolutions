...
> **Note**: If your key (password) has a **/** in it, the copy to clipboard will escape this character and replace it with **\/**.  This will cause the command to fail. Correct the escaped characters or copy the key directly from Azzure.
